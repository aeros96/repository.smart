...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR khaki][B]Fentastic[/B][/COLOR][COLOR snow]Wizard[/COLOR]'
...
THEME1 = u'[COLOR {color1}][COLOR {color1}]Fentastic Wizard: [/COLOR][COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2, color3=COLOR3)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing FentasticWizard.\n\nContact us at https://'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR khaki][B]Fentastic[/B][/COLOR][COLOR snow]Wizard[/COLOR]'
