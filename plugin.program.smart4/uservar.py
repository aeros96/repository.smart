...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkorange]Smart4 [/COLOR]Wizard'
BUILDERNAME = 'Aeros '
EXCLUDES = [ADDON_ID, 'repository.smart']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/aeros96/repository.smart/main/aeros/smartnetFentastic4.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Smart [/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The Smart Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkorange][B]Smart4[/B][/COLOR] Wizard'
