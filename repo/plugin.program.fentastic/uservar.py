...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkorange]Smartnet [/COLOR]Nexus Wizard'
BUILDERNAME = 'Aeros '
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Smartnet [/B][/COLOR][COLOR {color2}]Nexus Wizard[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The SmartNet Nexus Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkorange][B]SmartNet[/B][/COLOR] Nexus Wizard'
